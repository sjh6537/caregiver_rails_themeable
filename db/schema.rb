...
ActiveRecord::Schema[7.1].define(version: 2026_02_10_095500) do
  ...
  create_table "cared_facilities", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "cared_facility_event_types", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "cared_facility_events", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "cared_facility_types", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "health_hubs", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "community_id", comment: "社區ID"
    t.boolean "enable", default: true, null: false, comment: "啟用"
