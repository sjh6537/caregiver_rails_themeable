...
ActiveRecord::Schema[7.1].define(version: 2026_02_18_090100) do
  ...
  create_table "cared_facilities", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["cared_facility_type_id"], name: "index_cared_facilities_on_cared_facility_type_id"
    t.index ["cared_user_info_id"], name: "index_cared_facilities_on_cared_user_info_id"
  end

  create_table "cared_facility_event_types", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "cared_facility_events", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["cared_facility_event_type_id"], name: "index_cared_facility_events_on_cared_facility_event_type_id"
    t.index ["cared_facility_id"], name: "index_cared_facility_events_on_cared_facility_id"
  end

  create_table "cared_facility_types", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "communities", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.string "host", comment: "社群主網域"
    t.string "theme_key", limit: 50, default: "valex", null: false, comment: "主題鍵值"
    t.string "layout_preset", limit: 50, default: "valex", null: false, comment: "版型預設"
    t.json "theme_settings", comment: "主題設定(JSON)"
    t.index ["host"], name: "index_communities_on_host", unique: true
    t.index ["sn"], name: "index_communities_on_sn", unique: true
    t.index ["theme_key"], name: "index_communities_on_theme_key"
  end
  ...
  create_table "fitness_device_usages", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "fitness_device_id", null: false
    ...
    t.index ["fitness_device_id"], name: "index_fitness_device_usages_on_fitness_device_id"
    t.index ["user_id"], name: "index_fitness_device_usages_on_user_id"
  end
  ...
  create_table "health_hubs", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "community_id", comment: "社區ID"
    t.boolean "enable", default: true, null: false, comment: "啟用"
    t.datetime "purchase_date", comment: "購買日期"
    t.string "brand", limit: 50, comment: "品牌"
    t.string "address", limit: 200, comment: "地址"
    t.string "latitude", limit: 20, comment: "緯度"
    t.string "longitude", limit: 20, comment: "經度"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["community_id"], name: "index_health_hubs_on_community_id"
  end
  ...
  add_foreign_key "fitness_device_usages", "fitness_devices"
  add_foreign_key "fitness_device_usages", "users"
end
