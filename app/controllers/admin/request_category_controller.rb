# -*- encoding : utf-8 -*-
class Admin::RequestCategoryController < ApplicationAdminController
    ...
    def create
      ...
      respond_to do |format|
        if @category.save
          ...
          format.html { redirect_to admin_request_category_index_path, notice: I18n.t(:Created, scope: "Notice", name: "#{@category.text}") }
        else
          format.html { render action: "new", alert: I18n.t(:Created_Fail, scope: "Notice", name: "#{@category.text}") }
        end
      end
    end
