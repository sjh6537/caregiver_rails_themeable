  ...
  def create
    ...
    respond_to do |format|
      if @shop.save
        ...
        format.html do
          redirect_to admin_shop_path(@shop.id), notice: I18n.t(:Created, scope: 'Notice', name: "#{@shop.name}")
        end
      else
  ...
  def update
    ...
    respond_to do |format|
      if @shop.update(shop_params)
        ...
        format.html do
          redirect_to admin_shop_path(@shop.id), notice: I18n.t(:Updated, scope: 'Notice', name: "#{@shop.name}")
        end
      else
  ...
  def destroy
    respond_to do |format|
      ...
      if @shop.destroy
        ...
        format.html do
          redirect_back fallback_location: '/', alert: I18n.t(:Deleted_Fail, scope: 'Notice', name: "#{@shop.name}")
        end
      end
    end
  end
